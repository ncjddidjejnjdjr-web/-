...
ADMIN_TARGET = os.getenv("ADMIN_TARGET", "7809557665")  # عدد خودت را بگذار
...
async def send_joined_report(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        # اگر پیام به ادمین نرسید، ربات از کار نمی‌افته
        pass
...
# ========== راه‌اندازی همزمان سرور فلاسک و ربات ==========
...
def run_bot():
    ...
    async def main():
        ...
        print("🤖 ربات تلگرام با polling روشن شد و منتظر پیام‌هاست!")
...
def run_flask():
    ...
    # دریافت پورت از رندر (۱۰۰۰۰) و اجرای سرور
    PORT = int(os.environ.get('PORT', 10000))
    print(f"🌐 سرور وب روی پورت {PORT} باز شد تا رندر سرویس را زنده نگه دارد.")
